...
export default function MultipleChoiceQuestion({
  ...
  const getOptionStyle = (option: QuizOption) => {
    ...
    if (showResult) {
      ...
      if (isSelected) {
        baseClasses +=
          " bg-gradient-to-r from-purple-50 to-indigo-50 dark:from-purple-900/20 dark:to-indigo-900/20 border-purple-300 dark:border-purple-600 shadow-lg";
      } else if (isHovered) {
        baseClasses +=
          " bg-white/70 dark:bg-gray-800/70 border-purple-200 dark:border-purple-500 shadow-md";
      } else {
        baseClasses +=
          " bg-white/50 dark:bg-gray-800/50 border-gray-200 dark:border-gray-600 hover:border-purple-200 dark:hover:border-purple-500";
      }
    }
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      {/* Question Header */}
      <div className="bg-gradient-to-r from-gray-50 to-purple-50 dark:from-gray-800 dark:to-purple-900/20 p-4 sm:p-6 rounded-2xl border border-gray-200/50 dark:border-gray-700/50">
        ...
        {question.options?.map((option) => (
          ...
          >
            ...
            {!showResult && hoveredOption === option.id && (
              <div className="absolute inset-0 bg-purple-50 dark:bg-purple-900/10 rounded-xl opacity-0 animate-pulse" />
            )}
          </div>
        ))}
      </div>
      ...
      {!showResult && (
        <div className="text-center">
          <div className="inline-flex items-center px-3 sm:px-4 py-2 bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 rounded-full text-xs sm:text-sm font-medium">
            <svg
